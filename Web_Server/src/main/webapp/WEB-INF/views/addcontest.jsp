...
<body >
		...
		<div class="container">
			...
			<form action="${APP_PATH }/addcon" method="post">
				<h4>Exam&nbsp;&nbsp;&nbsp;<input required="required" name="title" type="text" class="form-control" style="width:500px; display:inline-block;"></h3>
				<h4>Start time&nbsp; 
