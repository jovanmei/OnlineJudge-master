...
<body >
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav newnavlink">
							...
							<li><a class="newnavlink" href="${APP_PATH }/admincontest">Course Operator</a></li>
						</ul>
		...
		<div class="container">
			...
			<form action="${APP_PATH }/uptpro/${proInfo.proId }" method="post" enctype="multipart/form-data">
				<h4>Problem Name&nbsp;&nbsp;&nbsp;<input required="required" value="${proInfo.proTitle }" name="title" type="text" class="form-control" style="width:500px; display:inline-block;"></h3>
				<h4>Time Limit(ms)&nbsp; 
				...
				<textarea required="required" name="proinf" cols="20" rows="4" wrap="virtual" class="form-control">${proInfo.proInfo }</textarea>
				<h4>Input Description</h4>
				<textarea required="required" name="input" cols="20" rows="3" wrap="virtual" class="form-control">${proInfo.proInput }</textarea>
				<h4>Output Description</h4>
				<textarea required="required" name="output" cols="20" rows="3" wrap="virtual" class="form-control">${proInfo.proOutput }</textarea>
				<h4>Input Description</h4>
				<textarea required="required" name="sinput" cols="20" rows="3" wrap="virtual" class="form-control">${proInfo.proSinput }</textarea>
				<h4>Output Description</h4>
				<textarea required="required" name="soutput" cols="20" rows="3" wrap="virtual" class="form-control">${proInfo.proSoutput }</textarea>
				<h4>Hint</h4>
				<textarea name="hit" cols="20" rows="3" wrap="virtual" class="form-control">${proInfo.proHint }</textarea>
