...
<body >
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav newnavlink">
							...
							<li class="active"><a href="${APP_PATH }/admincontest/1">Course Operator</a></li>
						</ul>
		...
		<div class="jumbotron subpad newbtline firstwindow">
			...
			<input type="submit" class="btn btn-danger toright" value="Delete"/>
<!-- 			<a class="btn btn-danger toright" href="#">Delete</a> -->
			<a class="btn btn-primary toright logomgn" href="${APP_PATH }/addcontest">Add</a>
					<tr>
						<td width="10%">#</td>
					...
					<tr>
						...
						<a class="btn btn-primary" href="${APP_PATH }/touptcon/${con.conId }">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="${APP_PATH }/deletecon/${pageInfo.pageNum }/${con.conId }">Del</a>
						</td>
					</tr>
					<c:remove var="str"/>
					<c:remove var="end"/>
