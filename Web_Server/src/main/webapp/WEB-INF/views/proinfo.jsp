				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav newnavlink">
							...
							<li><a class="newnavlink" href="${APP_PATH }/tocontestlist.jsp">Course</a></li>
...
<!-- 				</div> -->
				...
				<br/><br/>
				<textarea name="code" cols="55" rows="15" wrap="virtual" required="required"></textarea>
				<br>
				<button type="submit" class="btn btn-info">Submit</button>
				<a class="btn btn-link" href="${APP_PATH }/tosubmission.jsp">Status</a>
				</form>
			</div>
		</div>
