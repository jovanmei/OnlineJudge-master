			...
			<div class="modal-dialog">
				...
				<form action="${APP_PATH }/register" method="get">
					<div class="modal-header">
						<h2 class="newh3 tocenter">用户注册</h2>
					</div>
					<div class="modal-body">
						...
						<div class="form-group">
						    ...
						    <input required="required" name="nickname" type="text" class="form-control" placeholder="Nickname">
						</div>
						<div class="form-group">
					...
					<input type="submit" class="btn btn-info tocenter" value="立即注册">
